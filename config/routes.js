...
module.exports.routes = {
  ...
  'get    /users/sessions/new': 'UserSessionsController.new',
  'post   /users/sessions':     'UserSessionsController.create',
  'delete /users/sessions':     'UserSessionsController.destroy',

  'get    /users/registrations/new': 'UserRegistrationsController.new',
  'post   /users/registrations':     'UserRegistrationsController.create',

  'get    /users/profile': 'UserController.index',

  'get    /admins/users': 'AdminUsersController.index'
  /*
